...
<!--      <el-upload :action="serverHost+'/comment/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">-->
...
<!--      <el-button type="primary" @click="exp" class="ml-5">导出 <i class="el-icon-top"></i></el-button>-->
    ...
    <el-table :data="tableData" stripe @selection-change="handleSelectionChange" :header-cell-style="{'padding-left':'4px','padding-right':'4px'}">
      ...
      <el-table-column label="内容"><template v-slot="scope"><el-button type="primary" @click="views(scope.row.content)">查看</el-button></template></el-table-column>
      ...
      <el-table-column prop="itemId" label="关联宠物id"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="140px" size="small" style="width: 85%;" :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="originId" label="最上级评论id">
          <el-input v-model="form.originId" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item prop="itemId" label="关联id">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(this.serverHost+"/comment/export")
    },
