<template>
  <div style="margin: 10px 0;  width: 60%;margin: 0 auto;margin-top: 20px">
    <el-card style="">
      ...
      <el-button style="margin-bottom: 10px;float: right;margin-right: 20px" type="warning" @click="collect">收藏</el-button>
      <div style="display: flex">
        ...
        <div style="flex: 1; margin-left: 10px">
          <el-form label-width="80px" style="font-size: 20px">
            <el-form-item label="宠物名称">{{ item.name }}</el-form-item>
            <el-form-item label="所属分类">{{ item.cateName }}</el-form-item>
...
export default {
  ...
  methods: {
    ...
    load() {
      this.request.get('/pets/' + this.id).then(res => {
        this.item = res.data
      })
    },
