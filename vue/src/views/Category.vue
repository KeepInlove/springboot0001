...
<!--      <el-upload :action="serverHost+'/category/import'" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">-->
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open(this.serverHost+"/category/export")
    },
